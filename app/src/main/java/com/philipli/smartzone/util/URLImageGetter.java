...
import com.philipli.smartzone.network.HttpClient;
...
public class URLImageGetter implements Html.ImageGetter {
    ...
    private static final String mFilePath = SmartZoneApp.getInstance().getCacheDir().getAbsolutePath();
    ...
    private Drawable getDrawableFromNet(final String source) {
        ...
        RetrofitConfig.crateRetrofit(HttpClient.class).getNewsBodyHtmlPhoto(source)
    ...
    private Drawable createPicPlaceholder() {
        ...
        drawable = new ColorDrawable(SmartZoneApp.getInstance().getResources().getColor(color));
